...
We next verify  our conclusions from the above visualization that the design is a fuzzy disconintuity with a table examining if  there crabs under 70 mm harvested, and some over 70mm that weren't. 
```{r fuzzy-sharp-table}
crab_data  %>%
