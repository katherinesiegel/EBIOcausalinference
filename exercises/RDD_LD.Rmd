...
# equivalent to the two-step estimation below
# be careful! if there are missing values in the treatment D, you may fail to replicate the fuzzy effect by hand
